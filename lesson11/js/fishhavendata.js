const apiURL = 'https://api.openweathermap.org/data/2.5/forecast?id=5585010&appid=5bf449ff183a3e099f210e8427e72895';
...
fetch(apiURL)
    ...
    .then((jsObject) => {
        ...
        const allIcon = document.querySelectorAll('.weat-img');
